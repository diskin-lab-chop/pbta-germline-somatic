  ...
  add_model_os <- fit_save_model(group_hist[!grepl("EPN, H3 K28|CNS|EWS|classified", group_hist$mol_sub_group),],
                                  terms = ifelse(
                                     ...
                                     "mol_sub_group+extent_of_tumor_resection+age_at_diagnosis_days+cpgPLP_status",
                                      ifelse(
                                        group == "DIPG or DMG|Other high-grade glioma", "mol_sub_group+age_at_diagnosis_days+cpgPLP_status",
                                        ifelse(group %in% c("Atypical Teratoid Rhabdoid Tumor", "Ependymoma", "Medulloblastoma", "Mixed neuronal-glial tumor"),
