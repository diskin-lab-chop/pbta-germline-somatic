...
for (group in groups){
  ...
  coxph_os_model_file <- ifelse(group %in% c("Atypical Teratoid Rhabdoid Tumor",
  ...
  coxph_efs_model_file <- ifelse(group %in% c("Atypical Teratoid Rhabdoid Tumor",
                                               "Low-grade glioma", "Medulloblastoma", 
                                               "Mixed neuronal-glial tumor"),
                             file.path(results_dir,
  ...
  if (group %in% c("Atypical Teratoid Rhabdoid Tumor",
                   "Low-grade glioma", "Medulloblastoma", 
                   "Mixed neuronal-glial tumor")) {
     group_hist <- group_hist %>%
  ...
  add_model_os <- fit_save_model(group_hist[!grepl("EPN, H3 K28|CNS|EWS|SEGA", group_hist$mol_sub_group),],
                                  terms = ifelse(
                                     group %in% c("Atypical Teratoid Rhabdoid Tumor",
                                                  "Low-grade glioma", "Medulloblastoma", "Mixed neuronal-glial tumor"), 
                                     "mol_sub_group+extent_of_tumor_resection+cpgPLP_status",
                                      ifelse(
                                        group == "DIPG or DMG|Other high-grade glioma", "mol_sub_group+cpgPLP_status",
  ...
  add_model_efs <- fit_save_model(group_hist[!grepl("EPN, H3 K28|CNS|EWS|SEGA", group_hist$mol_sub_group),],
                                  terms = ifelse(
                                     group %in% c("Atypical Teratoid Rhabdoid Tumor",
                                                  "Low-grade glioma", "Medulloblastoma", "Mixed neuronal-glial tumor"), 
                                     "mol_sub_group+extent_of_tumor_resection+cpgPLP_status",
...
for (j in 1:nrow(subtype_df)) {
  ...
  coxph_os_model_file <- ifelse(subtype_df$hist[j] %in% c("Low-grade glioma", "Mixed neuronal-glial tumor", "Medulloblastoma"),
                             file.path(results_dir,
  ...
  coxph_efs_model_file <- ifelse(subtype_df$hist[j] %in% c("Low-grade glioma", "Mixed neuronal-glial tumor", "Medulloblastoma"),
                             file.path(results_dir,
  ...
  if (subtype_df$hist[j] %in% c("Low-grade glioma", "Mixed neuronal-glial tumor", "Medulloblastoma")){
    ...
    add_model_os <- fit_save_model(subtype_hist,
                                  terms = ifelse(subtype_df$hist[j] %in% c("Low-grade glioma", "Mixed neuronal-glial tumor", "Medulloblastoma"),
