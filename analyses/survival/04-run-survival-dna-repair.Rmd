...
int_os_model <- fit_save_model(hgg_hist,
                             "extent_of_tumor_resection+reported_gender+age_at_diagnosis_years+molecular_subtype*MMR_variant+molecular_subtype*brca_variant",
...
add_os_model <- fit_save_model(hgg_hist,
                             "extent_of_tumor_resection+reported_gender+molecular_subtype+age_at_diagnosis_years+MMR_variant+brca_variant",
