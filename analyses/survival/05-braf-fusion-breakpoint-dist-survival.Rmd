...
int_braf_fusions_plp_efs_model <- fit_save_model(fusions,
                                    "extent_of_tumor_resection+path_diagnosis+reported_gender+cpg_plp+age_at_diagnosis_years",
...
add_pa_plp_efs_model <- fit_save_model(pa_fusions,
                                    "extent_of_tumor_resection+reported_gender+cpg_plp+age_at_diagnosis_years",
