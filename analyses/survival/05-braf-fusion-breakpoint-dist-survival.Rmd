...
plp_lowVAF_file <- file.path(data_dir, "pbta-merged-plp-variants-autogvp-abridged-lowVAF-cpgs.tsv")
...
int_braf_fusions_plp_efs_model <- fit_save_model(fusions,
                                    "extent_of_tumor_resection+path_diagnosis+germline_sex_estimate+cpg_plp+age_at_diagnosis_years",
...
add_pa_plp_efs_model <- fit_save_model(pa_fusions,
                                    "extent_of_tumor_resection+germline_sex_estimate+cpg_plp+age_at_diagnosis_years",
