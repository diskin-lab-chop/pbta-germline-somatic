...
```{r}
fusion_resection_enr <- plot_enr(fusions[fusions$extent_of_tumor_resection != "Not Reported",], 
                       var2 = "breakpoint_group", 
...
dev.off()
```
Assess anatomical location by breakpoint group
...
fusion_region_enr <- plot_enr(fusions, 
                       ...
                       var1 = "CNS_region",
                       var2_names = c("15:09", "16:09", "16:11", "18:10", "rare"), 
                       var1_names = sort(unique(fusions$CNS_region)),
                       padjust = TRUE)

pdf(file.path(plot_dir, "breakpoint_group_region_enr_heatmap.pdf"),
    width = 4.5, height = 4)
