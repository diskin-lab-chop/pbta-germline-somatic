...
```{r}
int_mb_efs_model <- fit_save_model(mb_hist[!grepl("classified", mb_hist$molecular_subtype),],
                                "extent_of_tumor_resection+molecular_subtype+metastasis*cpg_plp",
                                file.path(results_dir, "coxph_int_EFS_mb_resection_subtype_metastasis_plp.RDS"),
                                "multivariate",
                                years_col = "EFS_years",
                                status_col = "EFS_status")

plotForest(readRDS(file.path(results_dir, "coxph_int_EFS_mb_resection_subtype_metastasis_plp.RDS")))

ggsave(file.path(plot_dir, "forest_EFS_int_mb_resection_subtype_metastasis_plp.pdf"),
...
```{r}
int_mb_os_model <- fit_save_model(mb_hist[!grepl("classified", mb_hist$molecular_subtype),],
                                "molecular_subtype+metastasis*cpg_plp",
                                file.path(results_dir, "coxph_int_OS_mb_resection_subtype_metastasis_plp.RDS"),
                                "multivariate",
                                years_col = "OS_years",
                                status_col = "OS_status")

plotForest(readRDS(file.path(results_dir, "coxph_int_OS_mb_resection_subtype_metastasis_plp.RDS")))

ggsave(file.path(plot_dir, "forest_OS_int_mb_resection_subtype_metastasis_plp.pdf"),
       width = 7, height = 3, units = "in")
```
