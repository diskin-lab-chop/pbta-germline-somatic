...
add_mb_efs_model <- fit_save_model(mb_hist[!grepl("classified", mb_hist$molecular_subtype),],
                                "extent_of_tumor_resection+molecular_subtype+germline_sex_estimate+mt+cpg_plp+age_at_diagnosis_years",
...
for (subtype in subtypes){
  ...
  add_mb_efs_model <- fit_save_model(mb_hist[mb_hist$molecular_subtype == subtype,],
                                "extent_of_tumor_resection+germline_sex_estimate+mt+cpg_plp+age_at_diagnosis_years",
...
add_mb_g4_efs_model <- fit_save_model(mb_hist[mb_hist$molecular_subtype == "MB, Group4" & grepl("G34", mb_hist$dkfz_v12_methylation_subclass),],
                                "extent_of_tumor_resection+dkfz_v12_methylation_subclass+germline_sex_estimate+cpg_plp+age_at_diagnosis_years",
