...
mb_hist <- mb_hist %>%
  ...
  # rename Group 3/4 methylation subgroups; in this cohort, subgroups 1-4 are all Group3 and subgroups 5-8 are all Group4
  dplyr::mutate(dkfz_v12_methylation_subclass = case_when(
    dkfz_v12_methylation_subclass == "MB_G34_II" ~ "MB, Group3, subgroup 2",
    dkfz_v12_methylation_subclass == "MB_G34_III" ~ "MB, Group3, subgroup 3",
    dkfz_v12_methylation_subclass == "MB_G34_IV" ~ "MB, Group3, subgroup 4",
    dkfz_v12_methylation_subclass == "MB_G34_V" ~ "MB, Group4, subgroup 5",
    dkfz_v12_methylation_subclass == "MB_G34_VI" ~ "MB, Group4, subgroup 6",
    dkfz_v12_methylation_subclass == "MB_G34_VII" ~ "MB, Group4, subgroup 7",
    dkfz_v12_methylation_subclass == "MB_G34_VIII" ~ "MB, Group4, subgroup 8"
  ))
```
...
```{r}
g3_plp_enr <- plot_enr(mb_hist[mb_hist$molecular_subtype == "MB, Group3" & grepl("Group3", mb_hist$dkfz_v12_methylation_subclass),], 
                       var1 = "dkfz_v12_methylation_subclass", 
                       var2 = "cpg_plp",
                       var1_names = c("MB, Group3, subgroup 2",
                                      "MB, Group3, subgroup 3",
                                      "MB, Group3, subgroup 4"), 
                       var2_names = c("No P-LP", "CPG P-LP"),
                       padjust = FALSE)
...
```{r}
g4_plp_enr <- plot_enr(mb_hist[mb_hist$molecular_subtype == "MB, Group4" & grepl("Group4", mb_hist$dkfz_v12_methylation_subclass),], 
                       var1 = "dkfz_v12_methylation_subclass", 
                       var2 = "cpg_plp",
                       var1_names = c("MB, Group4, subgroup 5",
                                      "MB, Group4, subgroup 6",
                                      "MB, Group4, subgroup 7",
                                      "MB, Group4, subgroup 8"), 
                       var2_names = c("No P-LP", "CPG P-LP"),
                       padjust = FALSE)
