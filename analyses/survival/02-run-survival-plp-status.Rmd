...
plot_names <- c("ATRT", "CPT", "CRANIO", "HGG", "EPN", "LGG", "MB", "MNG", "MES", "GNG-GNT", "NFP")
...
for (j in 1:nrow(subtypes)) {
  ...
  if (subtypes$plot_group[j] %in% c("Low-grade glioma")){
    ...
    add_model_os <- fit_save_model(subtype_hist,
                                  terms = ifelse(subtypes$plot_group[j] %in% c("Low-grade glioma"),
                                                 ...
                                                 ifelse(subtypes$plot_group[j] %in% c("DIPG or DMG", "Other high-grade glioma"),
                                                        "molecular_subtype+age_at_diagnosis_years+cpgPLP_status",
                                                        "age_at_diagnosis_years+cpgPLP_status")),
                                   coxph_os_model_file,
                                   "multivariate",
                                   years_col = "OS_years",
