...
for (group in groups){
  ...
  add_model_os <- fit_save_model(group_hist[!grepl("To be classified", group_hist$mol_sub_group) & !grepl("Unavailable", group_hist$extent_of_tumor_resection),],
                                  terms = ifelse(
                                     ...
                                     "mol_sub_group+extent_of_tumor_resection+reported_gender+cpgPLP_status+age_at_diagnosis_years",
                                     ifelse(group %in% c("Other high-grade glioma"),
                                            "extent_of_tumor_resection+molecular_subtype+reported_gender+cpgPLP_status+age_at_diagnosis_years",
                                            ifelse(group == "DIPG or DMG",
                                                   "molecular_subtype+reported_gender+cpgPLP_status+age_at_diagnosis_years",
                                                   ifelse(group %in% c("Atypical Teratoid Rhabdoid Tumor", "Medulloblastoma"),
                                                          "extent_of_tumor_resection+mol_sub_group+reported_gender+cpgPLP_status+age_at_diagnosis_years",
                                                          ifelse(group %in% c("Mixed neuronal-glial tumor", "Ependymom"),
                                                                 "mol_sub_group+reported_gender+cpgPLP_status+age_at_diagnosis_years",
                                                                 ifelse(group %in% c("Choroid plexus tumor", "Mesenchymal tumor",
                                                                                     "Meningioma", "Schwannoma"),
                                                                        "extent_of_tumor_resection+reported_gender+cpgPLP_status+age_at_diagnosis_years",
                                                                        "reported_gender+cpgPLP_status+age_at_diagnosis_years"
                                                                        )))))),
             coxph_os_model_file,
             "multivariate",
             years_col = "OS_years",
