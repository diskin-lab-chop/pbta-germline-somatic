...
plp_predisposition_syndromes <- hist %>%
  ...
  left_join(plp[,c("Kids_First_Biospecimen_ID_normal", "gene_symbol_vep", "autogvp_call", "autogvp_call_reason", "HGVSc", "HGVSp")]) %>%
  ...
  select(Kids_First_Participant_ID, Kids_First_Biospecimen_ID_normal, plot_group, molecular_subtype, 
