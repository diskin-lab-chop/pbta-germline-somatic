...
genes <- plp %>%
  ...
  dplyr::filter(n >= 3 & Hugo_Symbol %in% cpg) %>%
  pull(Hugo_Symbol)
...
for (gene in genes){
  ...
  snv_mat <- table(is_plp = hist$Kids_First_Biospecimen_ID_tumor %in% plp_gene_tumors, 
                   is_alt = factor(hist$Kids_First_Biospecimen_ID_tumor %in% gene_maf$Tumor_Sample_Barcode, levels = c("FALSE", "TRUE")))
  ...
  cnv_loss_mat <- table(is_plp = hist$Kids_First_Biospecimen_ID_tumor %in% plp_gene_tumors,
                        is_alt = factor(hist$Kids_First_Biospecimen_ID_tumor %in% gene_cnv_loss$biospecimen_id, levels = c("FALSE", "TRUE")))
  ...
  cnv_gain_mat <- table(is_plp = hist$Kids_First_Biospecimen_ID_tumor %in% plp_gene_tumors,
                        is_alt = factor(hist$Kids_First_Biospecimen_ID_tumor %in% gene_cnv_gain$biospecimen_id, levels = c("FALSE", "TRUE")))
  ...
  gene_loh <- loh %>%
    dplyr::filter(Hugo_Symbol == gene & LOH_score > 0.2)
  
  # Create contingency table and store stats for LOH enrichment 
  loh_mat <- table(is_plp = hist$Kids_First_Biospecimen_ID_tumor %in% plp_gene_tumors,
                        is_alt = factor(hist$Kids_First_Biospecimen_ID_tumor %in% gene_loh$Kids_First_Biospecimen_ID_tumor, levels = c("FALSE", "TRUE")))
  ...
  expr_loss_mat <- table(is_plp = hist$Kids_First_Biospecimen_ID[!is.na(hist$Kids_First_Biospecimen_ID)] %in% plp_gene_rna,
                   is_alt = factor(hist$Kids_First_Biospecimen_ID[!is.na(hist$Kids_First_Biospecimen_ID)] %in% gene_expr_loss$Kids_First_Biospecimen_ID, levels = c("FALSE", "TRUE")))
  ...
  expr_gain_mat <- table(is_plp = hist$Kids_First_Biospecimen_ID[!is.na(hist$Kids_First_Biospecimen_ID)] %in% plp_gene_rna,
                   is_alt = factor(hist$Kids_First_Biospecimen_ID[!is.na(hist$Kids_First_Biospecimen_ID)] %in% gene_expr_gain$Kids_First_Biospecimen_ID, levels = c("FALSE", "TRUE")))
