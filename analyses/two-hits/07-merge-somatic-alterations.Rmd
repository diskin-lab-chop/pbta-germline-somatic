...
onco_snv_file <- file.path(input_dir, "germline-somatic-two-gene-hits.tsv")
sv_onco_snv_file <- file.path(input_dir, "germline-sv-somatic-two-gene-hits.tsv")

cnv_loh_file <- file.path(input_dir, "germline-somatic-cnv-loh-cpgs.tsv")
sv_cnv_loh_file <- file.path(input_dir, "germline-sv-somatic-cnv-loh-somatic-cpgs.tsv")

expr_file <- file.path(input_dir, "germline-somatic-expr-cpgs.tsv")
sv_expr_file <- file.path(input_dir, "germline-sv-somatic-expr-cpgs.tsv")

proteo_file <- file.path(input_dir, "germline-somatic-proteomics-phosphoproteomics-cpgs.tsv")
sv_proteo_file <- file.path(input_dir, "germline-sv-somatic-proteomics-phosphoproteomics-cpgs.tsv")
```
