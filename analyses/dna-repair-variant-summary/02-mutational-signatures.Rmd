...
dna_repair_plp_summary_file <- file.path(results_dir, 'dna_repair_germline_plp_summary.tsv')
...
mmr_plp_file <- file.path(results_dir, 'mmr_germline_variant_plp.tsv')
dna_repair_plp_file <- file.path(results_dir, 'dna_repair_germline_variant_plp.tsv')
```
...
```{r}
dna_repair_plp_summary <- read_tsv(dna_repair_plp_summary_file) %>%
  rename('Kids_First_Biospecimen_ID' = 'Kids_First_Biospecimen_ID_normal')
hist <- read_tsv(histologies_file) 

repair_germline <- dna_repair_plp_summary %>%
  filter(dna_repair_germline == 'Yes') %>%
  pull(Kids_First_Biospecimen_ID)

ctrl_germline <- dna_repair_plp_summary %>%
...
for (i in 1:length(cosmicv2_sigs)){
  ...
  cosmicv2_res$pvalue[i] <- wilcox.test(repair_exposures, ctrl_exposures, alternative = 'two.sided')$p.value
}

write_tsv(cosmicv2_res, file.path(results_dir, 'cosmicv2_sig_diff_DNArepair_vs_other.tsv'))
```
...
ggsave(
  file.path(plot_dir, "cosmicv2_signature_diff_DNArepair_vs_other.pdf"), 
...
write_tsv(cosmicv3_res, file.path(results_dir, 'cosmicv3_sig_diff_DNArepair_vs_other.tsv'))
```
...
ggsave(
  file.path(plot_dir, "cosmicv3_signature_diff_DNArepair_vs_other.pdf"), 
  width = 30, height = 15, units = "cm")
```
...
```{r}
mmr_germline <- dna_repair_plp_summary %>%
  filter(mmr_germline == 'Yes') %>%
  pull(Kids_First_Biospecimen_ID)

mmr_ctrl_germline <- dna_repair_plp_summary %>%
...
write_tsv(mmr_cosmicv2_res, file.path(results_dir, 'cosmicv2_sig_diff_MMR_vs_other.tsv'))
```
...
ggsave(
  file.path(plot_dir, "cosmicv2_signature_diff_MMR_vs_other.pdf"), 
  width = 30, height = 15, units = "cm")
```
...
write_tsv(mmr_cosmicv3_res, file.path(results_dir, 'cosmicv3_sig_diff_MMR_vs_other.tsv'))
```
...
ggsave(
  file.path(plot_dir, "cosmicv3_signature_diff_MMR_vs_other.pdf"), 
  width = 30, height = 15, units = "cm")
```
...
```{r}
nonmmr_germline <- dna_repair_plp_summary %>%
  filter(mmr_germline == 'No' & dna_repair_germline == 'Yes') %>%
  pull(Kids_First_Biospecimen_ID)

nonmmr_ctrl_germline <- dna_repair_plp_summary %>%
  filter(dna_repair_germline == 'No') %>%
  pull(Kids_First_Biospecimen_ID)
...
write_tsv(nonmmr_cosmicv2_res, file.path(results_dir, 'cosmicv2_sig_diff_DNArepair_nonMMR_vs_other.tsv'))
```
...
ggsave(
  file.path(plot_dir, "cosmicv2_signature_diff_DNArepair_nonMMR_vs_other.pdf"), 
  width = 30, height = 15, units = "cm")
```
...
write_tsv(nonmmr_cosmicv3_res, file.path(results_dir, 'cosmicv3_sig_diff_DNArepair_nonMMR_vs_other.tsv'))
```
...
ggsave(
  file.path(plot_dir, "cosmicv3_signature_diff_DNArepair_nonMMR_vs_other.pdf"), 
  width = 30, height = 15, units = "cm")
```
...
ggsave(
  file.path(plot_dir, "SBS14_signature_byGroup_violinPlot.pdf"), 
...
ggsave(
  file.path(plot_dir, "SBS15_signature_byGroup_violinPlot.pdf"), 
  width = 20, height = 15, units = "cm")
```
...
ggsave(
  file.path(plot_dir, "SBS6_signature_byGroup_violinPlot.pdf"), 
  width = 20, height = 15, units = "cm")
```
...
ggsave(
  file.path(plot_dir, "MMR_signature_byGroup_violinPlot.pdf"), 
  width = 20, height = 15, units = "cm")
```

```{r}
mmr_plp <- read_tsv(mmr_plp_file) %>%
  ...
  left_join(sbs6_df[c('Kids_First_Biospecimen_ID', 'exposure')], by = 'Kids_First_Biospecimen_ID') %>%
  left_join(sbs14_df[c('Kids_First_Biospecimen_ID', 'exposure')], by = 'Kids_First_Biospecimen_ID') %>%
  left_join(sbs15_df[c('Kids_First_Biospecimen_ID', 'exposure')], by = 'Kids_First_Biospecimen_ID') %>%
  rename('SBS6_exposure' = 'exposure.x', 'SBS14_exposure' = 'exposure.y', 'SBS15_exposure' = 'exposure') %>%
  write_tsv(file.path(results_dir, 'MMR_germline_variant_plp_with_MMRsigs.tsv'))
```  
  
```{r}
dnarepair_plp <- read_tsv(dna_repair_plp_file) %>%
  rename('Kids_First_Biospecimen_ID_normal' = 'Kids_First_Biospecimen_ID') %>%
  left_join(hist[,c('Kids_First_Biospecimen_ID_normal', 'Kids_First_Biospecimen_ID_tumor')], by = 'Kids_First_Biospecimen_ID_normal') %>%
  rename('Kids_First_Biospecimen_ID' = 'Kids_First_Biospecimen_ID_tumor') %>%
  left_join(mmr_df[c('Kids_First_Biospecimen_ID', 'sum')], by = 'Kids_First_Biospecimen_ID') %>%
  ...
  left_join(sbs15_df[c('Kids_First_Biospecimen_ID', 'exposure')], by = 'Kids_First_Biospecimen_ID') %>%
  rename('SBS6_exposure' = 'exposure.x', 'SBS14_exposure' = 'exposure.y', 'SBS15_exposure' = 'exposure') %>%
  write_tsv(file.path(results_dir, 'DNArepair_germline_variant_plp_with_MMRsigs.tsv'))
```  