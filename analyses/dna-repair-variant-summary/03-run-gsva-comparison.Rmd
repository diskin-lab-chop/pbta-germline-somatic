...
pathways <- c("HALLMARK_HEDGEHOG_SIGNALING", "HALLMARK_DNA_REPAIR", "HALLMARK_PROTEIN_SECRETION")
...
pathways <- c("KEGG_GLIOMA", "KEGG_ERBB_SIGNALING_PATHWAY")
