...
hallmark_to_plot <- c("HALLMARK_G2M_CHECKPOINT", "HALLMARK_DNA_REPAIR", "HALLMARK_E2F_TARGETS",
                      "HALLMARK_TGF_BETA_SIGNALING", "HALLMARK_P53_PATHWAY",
                      "HALLMARK_INTERFERON_GAMMA_RESPONSE")
kegg_to_plot <- c("KEGG_LYSOSOME", "KEGG_NON_HOMOLOGOUS_END_JOINING")
