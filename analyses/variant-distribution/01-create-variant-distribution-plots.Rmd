...
```{r data wrangling}
plp <- read_tsv(file.path(input_dir, "pbta_germline_plp_calls_autogvp_abridged_gnomad_popmax.tsv"), 
...
```{r}
plp_full <- read_tsv(file.path(input_dir,
                               "pbta_germline_plp_calls_autogvp_full_gnomad_popmax.tsv")) %>%
